...
class NetworkingService {
    ...
    func fetchAllPosts(completion: @escaping ([PostDTO]?, Error?) -> ()){
        completion([
            ...
            PostDTO(id: 3, title: "Как я сходил на почту", images: ["https://cs13.pikabu.ru/post_img/big/2020/12/05/6/1607160782156451314.png"], body: "Почта России в Кудрово, работает с апреля месяца с 09:00 до 18:00 что оставляет большинству рабочего населения вроде меня попасть туда только в субботу, но в единственный день забрать свои посылки, увидев очередь с улицы метров на двадцать, чувствуешь что что-то пошло не так. От безысходности набираю горячую линию почты и там отвечают \"если перед вами очередь больше пяти человек нажмите один\" заржал в голос прям на улице."),
            PostDTO(id: 4, title: "2 title", images: ["https://cs10.pikabu.ru/post_img/big/2020/12/05/6/1607157210190920563.jpg"], body: "2 Text Text Text Text Text TextText Text Text Text Text Text"),
            PostDTO(id: 5, title: "3 title", images: nil, body: nil),
            PostDTO(id: 6, title: "33 title", images: ["https://cs13.pikabu.ru/post_img/big/2020/12/05/2/1607133331192266118.jpg", "https://cs10.pikabu.ru/post_img/big/2020/12/05/2/160713333816716139.jpg", "https://cs12.pikabu.ru/post_img/big/2020/12/05/2/1607133359121840238.jpg"], body: "3 Text Text Text Text Text Text"),
